    ...
    <section class="portfolio-write-section request-write-section">
      <form class="portfolio-write-form" data-request-create-form>
        <div class="portfolio-editor-pane">
          <input class="portfolio-title-input" name="postTitle" type="text" maxlength="100" required placeholder="요청글 제목을 입력하세요" aria-label="요청글 제목" data-portfolio-title-input />
